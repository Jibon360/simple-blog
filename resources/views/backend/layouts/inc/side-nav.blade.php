     ...
     <aside id="sidebar-wrapper">
         <div class="sidebar-brand">
             <a href="index.html"> <img alt="image" src="{{ asset('backend') }}/assets/img/logo.png"
                     class="header-logo" />
                 <span class="logo-name">{{ Auth::user()->name }}</span>
             </a>
         </div>
         <ul class="sidebar-menu">
             ...
             <li class="dropdown @yield('post')">
                 <a href="" class="menu-toggle nav-link has-dropdown"><i
                         data-feather="command"></i><span>Post</span></a>
                 <ul class="dropdown-menu">
                     <li><a class="nav-link" href="{{ route('post.create') }}">Created post</a></li>
                     <li><a class="nav-link" href="{{ route('post.index') }}">List Post post</a></li>
